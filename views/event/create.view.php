    ...
    <main>
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="/society/{{id}}/event/create" method="POST" enctype="multipart/form-data">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <br/>
                            <input type="hidden" name="_lat" id="_lat" value="">
                            <input type="hidden" name="_lon" id="_lon" value="">
                            <input type="hidden" name="_location" id="_location" value="">
                        </div>
                        <p id="streetName" class="block text-sm font-small leading-6 text-gray-400"></p>
                    </div>
...
<script type='text/javascript'>
    ...
    function GetMap() {
        map = new Microsoft.Maps.Map(document.getElementById("myMap"), {
            center: new Microsoft.Maps.Location(41.3441, 21.5528),
            zoom: 13
        });
